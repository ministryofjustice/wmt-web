...
const archiveReductionInsertsPath = path.resolve(__dirname, '../../../archiveReductionInserts.json')
...
module.exports = function () {
  try {
    ...
    const archiveReductionInserts = JSON.parse(readFileSync(archiveReductionInsertsPath, 'utf8'))

    return dailyArchiveDataHelper.deleteDailyArchiveByIds(archiveInserts[0].id).then(function () {
      return archiveReductionDataHelper.deleteArchiveReductionsByIds(archiveReductionInserts[0].id).then(function () {
