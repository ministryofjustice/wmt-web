...
module.exports = {
  ...
  LIVE_DATABASE_USERNAME: process.env.WMT_LIVE_DB_USERNAME || 'postgres',
  LIVE_DATABASE_PASSWORD: process.env.WMT_LIVE_DB_PASSWORD || 'postgres',

  HISTORY_DATABASE_SERVER: process.env.WMT_HISTORY_DB_SERVER || '127.0.0.1',
  HISTORY_DATABASE_PORT: process.env.WMT_HISTORY_DB_PORT || '5432',
  HISTORY_DATABASE: process.env.WMT_HISTORY_DB_NAME || 'postgres',
  HISTORY_DATABASE_USERNAME: process.env.WMT_HISTORY_DB_USERNAME || 'postgres',
  HISTORY_DATABASE_PASSWORD: process.env.WMT_HISTORY_DB_PASSWORD || 'postgres',
